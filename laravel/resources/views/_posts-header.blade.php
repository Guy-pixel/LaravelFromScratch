<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-4">
        <!--  Category -->
        <div class="lg:inline-flex relative bg-gray-100 rounded-xl">
            <x-dropdown :categories="$categories">
                ...
                {{--
                you can also check :active using:
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl px-3 py-2">
            <form method="GET" action="#">
                <input type="text" name="search" placeholder="Find something"
                    class="bg-transparent placeholder-black font-semibold text-sm" value="{{ ucwords(request('search') ?? '') }}">
            </form>
        </div>
    </div>
</header>
